<section class="w-full">
    ...
    <x-settings.layout>
        <div class="space-y-6">
            ...
            <div class="rounded-xl p-5 shadow-lg" style="background-color: var(--index-card-bg);">
                @if($admins->count())
                    <div class="space-y-3 rounded-xl p-4">
                        @foreach($admins as $admin)
                            <div class="group relative rounded-xl p-4 transition-all duration-200 hover:shadow-lg border"
                                 style="background-color: var(--index-card-bg-secondary); 
                                ...
                                <div class="flex items-center gap-4">
                                    ...
                                    <div class="flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                                        ...
                                        <button 
                                            ...
                                            class="inline-flex items-center justify-center w-9 h-9 rounded-lg transition-all hover:scale-110"
                                            style="color: var(--index-btn-danger-text); 
                                                   background-color: var(--index-btn-danger-bg); 
                                                   border: 1px solid var(--index-btn-danger-border);"
                ...
                <flux:modal wire:model="isModalOpen" :dismissible="false" class="w-[95vw] sm:w-[450px] max-w-[95vw]">
                    <div class="flex flex-col max-h-[85vh]">
                        ...
                        <div class="relative px-6 py-5 flex items-center gap-4 overflow-hidden flex-shrink-0 rounded-t-xl border-b"
                             style="background: linear-gradient(135deg, var(--index-card-bg) 0%, var(--index-card-bg-secondary) 100%);
                        ...
                        {{-- Contenido --}}
                        <div class="flex-1 overflow-y-auto p-6" style="background-color: var(--index-card-bg-secondary);">
                            <div class="space-y-4">
                        ...
                        <div class="px-6 py-4 flex flex-col-reverse sm:flex-row items-center justify-end gap-3 border-t flex-shrink-0 rounded-b-xl"
                             style="background-color: var(--index-card-bg-secondary); border-color: var(--index-border);">
                            <flux:modal.close>
