<div class="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3 sm:gap-5">
    @foreach($careers as $career)
        ...
        <div wire:click="edit({{ $career->id }})" class="period-card period-card--clickable group">
            ...
            <div class="flex justify-end mb-2 lg:hidden">
                <x-status-badge :active="$career->is_active" />
            </div>

            <div class="period-card-header">
                <h3 class="period-card-name" style="margin:0;">{{ $career->name }}</h3>
            ...
            <div class="period-card-footer">
                ...
                <button wire:click.stop="edit({{ $career->id }})"
