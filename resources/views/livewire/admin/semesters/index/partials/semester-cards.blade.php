<div class="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3 sm:gap-5">
    @foreach($semesters as $semester)
        ...
        <div wire:click="edit({{ $semester->id }})" class="period-card period-card--clickable group">
            ...
            <div class="flex justify-end mb-2 lg:hidden">
                <x-status-badge :active="$semester->is_active" />
            </div>

            <div class="period-card-header">
                <h3 class="period-card-name" style="margin:0;">{{ $semester->name }}</h3>
            ...
            <div class="period-card-footer" style="justify-content:flex-end;">
                <button wire:click.stop="edit({{ $semester->id }})"
