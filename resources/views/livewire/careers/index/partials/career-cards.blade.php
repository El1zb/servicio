        ...
        <div class="period-card group">
            <div class="stat-card-top">
                <div class="min-w-0 flex-1 flex flex-col gap-2">
                    <p class="stat-card-label">{{ $career->name }}</p>
                    <span class="period-card-status {{ $career->is_active ? 'is-active' : '' }}" style="align-self:flex-start;">
                ...
                <div class="stat-card-icon">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor">
                        <path d="M12 6.04A9 9 0 006 3.75c-1.05 0-2.06.18-3 .51v14.25A9 9 0 016 18c2.3 0 4.41.87 6 2.29m0-14.25A9 9 0 0118 3.75c1.05 0 2.06.18 3 .51v14.25A9 9 0 0018 18a9 9 0 00-6 2.29m0-14.25v14.25" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                </div>
            </div>
            ...
            <div class="period-card-footer">
                <p class="stat-card-description" style="margin:0;">
                    ...
                    {{ $career->campuses_count }} {{ $career->campuses_count === 1 ? 'plantel relacionado' : 'planteles relacionados' }}
                </p>
