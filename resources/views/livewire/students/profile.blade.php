<div class="flex flex-col gap-6
    ...
    @if ($showForm)
        <form method="POST" wire:submit.prevent="save" class="flex flex-col gap-6">
            ...
            <!-- DATOS PERSONALES -->
            <div class="bg-[var(--index-card-bg)] rounded-xl border border-[var(--index-border)] 
                        shadow-[0_2px_8px_rgba(0,0,0,0.08)] overflow-hidden transition-all duration-300 hover:shadow-[0_4px_12px_rgba(0,0,0,0.12)]">
                
                <div class="p-6 pb-4" 
                    style="background: linear-gradient(135deg, var(--index-card-bg) 0%, var(--index-card-bg) 100%);">
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <flux:input 
                            ...
                            style="background-color: var(--index-card-bg); color: var(--index-text-primary); border: 1px solid var(--index-border); text-transform: uppercase;"
                        ...
                        <flux:input 
                            ...
                            title="RFC válido (12 o 13 caracteres, en mayúsculas)" 
                            style="background-color: var(--index-card-bg); color: var(--index-text-primary); border: 1px solid var(--index-border); text-transform: uppercase;"
            ...
            <div class="bg-[var(--index-card-bg)] rounded-xl border border-[var(--index-border)] 
                ...
                <div class="p-6 pb-4" 
                    style="background: linear-gradient(135deg, var(--index-brand-primary) 0%, var(--index-brand-primary) 100%);">
                    <div class="flex items-center gap-3">
                        <h2 class="text-lg font-semibold text-[var(--index-icon-text)]!">
                            Datos Académicos
                        </h2>
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <flux:input 
                            ...
                            type="email" 
                            inputmode="email" 
                            placeholder="Ej. l225q0000@itsco.edu.mx" 
                            required 
                            pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}" 
                            title="Ingresa un correo válido" 
                            style="background-color: var(--index-card-bg); color: var(--index-text-primary); border: 1px solid var(--index-border);"
                ...
                <div class="bg-[var(--index-card-bg)] border border-[var(--index-border)] p-6 rounded-xl shadow-lg">
                    <div class="flex items-start gap-4">
                        <div class="flex-shrink-0 mt-1">
                            <div class="w-10 h-10 bg-[var(--index-status-normal-bg)] rounded-full flex items-center justify-center">
                                <svg class="w-6 h-6 text-[var(--index-status-normal-icon)]" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-[var(--index-text-secondary)] text-sm leading-relaxed">
                    ...
                    <div class="flex items-start gap-4">
                        <div class="flex-shrink-0 mt-1">
                            <div class="w-10 h-10 bg-[var(--index-status-approved-bg)] rounded-full flex items-center justify-center">
                                <svg class="w-6 h-6 text-[var(--index-status-approved-icon)]" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    ...
                    <div class="flex items-start gap-4">
                        <div class="flex-shrink-0 mt-1">
                            <div class="w-10 h-10 bg-[var(--index-status-rejected-bg)] rounded-full flex items-center justify-center">
                                <svg class="w-6 h-6 text-[var(--index-status-rejected-icon)]" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
