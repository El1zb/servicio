    ...
    <div class="flex items-start gap-4">
        <div class="flex-shrink-0 mt-1">
            <div class="w-10 h-10 bg-red-500/10 rounded-full flex items-center justify-center">
                <svg class="w-6 h-6 text-red-400" xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="flex-1">
            ...
            <p class="text-[var(--color-secondary)] text-sm leading-relaxed mb-3">
            ...
            @if($student->rejection_reason)
                <div class="bg-[var(--color-icon-bg)] p-4 rounded-lg mb-4">
                    <p class="text-xs font-semibold text-red-400 uppercase tracking-wide mb-2">
                        Motivo del Rechazo
                    </p>
                    <p class="text-sm text-[var(--color-secondary)] leading-relaxed">
