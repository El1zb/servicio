<div class="p-6">
    ...
    <div class="flex flex-col md:flex-row gap-4 mb-4">
        <flux:input type="text" wire:model.live="search" placeholder="Buscar por nombre o número de control..." />
    ...
    <div class="mb-4">
        <button wire:click="exportExcel" class="px-4 py-2 bg-green-500 text-white rounded hover:bg-green-600">
            Exportar Excel
        </button>
    </div>
