    ...
    @php
        $statCards = [
            ...
            [
                ...
                'bg'         => 'var(--color-icon-bg)',
                'icon_color' => 'var(--color-primary-2)',
    ...
    @foreach($statCards as $card)
        <div class="rounded-xl p-6 shadow-lg" style="background-color: var(--color-card-bg);">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-xs font-medium uppercase tracking-wide" style="color: var(--color-secondary);">
                        {{ $card['label'] }}
                    </p>
                    <p class="text-2xl font-bold mt-0.5" style="color: var(--color-primary-2);">
                        {{ $card['value'] }}
                    </p>
                </div>
            </div>
