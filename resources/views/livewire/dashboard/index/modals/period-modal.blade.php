    ...
    <div class="flex flex-col" style="height: 80vh; max-height: 88vh;">
            ...
            <div class="flex-shrink-0 ml-3">
                @if($periodId)
                    <span class="inline-flex items-center px-2.5 py-1 rounded-lg text-xs font-semibold border"
                        style="{{ $is_active
                            ? 'background-color: rgba(16,185,129,0.1); color: rgb(52,211,153); border-color: rgba(16,185,129,0.3);'
                            : 'background-color: var(--color-icon-bg); color: var(--color-secondary); border-color: var(--color-border-hover);' }}">
                        {{ $is_active ? 'Activo' : 'Inactivo' }}
                    </span>
                @else
                    <span class="inline-flex items-center px-2.5 py-1 rounded-lg text-xs font-semibold border"
                        style="background-color: var(--color-icon-bg); color: var(--color-secondary); border-color: var(--color-border-hover);">
                        Nuevo
                    </span>
                @endif
            </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-[1fr_320px] xl:grid-cols-[1fr_360px] gap-0 flex-1 overflow-hidden">
            ...
            <div class="flex flex-col overflow-y-auto"
                style="border-right: 1px solid var(--color-border-hover); background-color: var(--color-card-bg);">
                ...
                <div class="flex flex-col gap-3 p-3 sm:p-4">
                    ...
                    <div class="p-3 rounded-lg border"
                        ...
                        <input type="text"
                            ...
                            style="background-color: var(--color-card-bg);
                                   ...
                                   --tw-ring-color: var(--color-indicator);">
                    ...
                    <div class="p-3 rounded-lg border"
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-2">
                            ...
                            {{-- Fecha inicio --}}
                            <div>
                                <p class="text-xs mb-1.5" style="color: var(--color-secondary);">Fecha de Inicio</p>
                                <input type="date"
                            ...
                            {{-- Fecha fin --}}
                            <div>
                                <p class="text-xs mb-1.5" style="color: var(--color-secondary);">Fecha de Término</p>
                                <input type="date"
                    ...
                    <div class="p-3 rounded-lg border flex flex-col"
                        ...
                        <div class="rounded-lg border overflow-y-auto"
                            style="max-height: 220px; border-color: var(--color-border-hover); background-color: var(--color-card-bg);">
                            ...
                            @forelse($semesters as $semester)
                                <label class="flex items-center gap-3 px-3 py-2 cursor-pointer transition-all border-b last:border-b-0"
                                    ...
                                    onmouseover="this.style.backgroundColor='var(--color-icon-bg)'"
                                    onmouseout="this.style.backgroundColor='transparent'">
                                    <flux:checkbox wire:model.defer="selectedSemesters" value="{{ $semester->id }}"
                                        class="flex-shrink-0"/>
                                    <span class="text-xs font-medium" style="color: var(--color-primary-2);">
                                        {{ $semester->name }}
                                    </span>
                                </label>
                            @empty
                                <div class="flex flex-col items-center justify-center py-8 text-center px-4">
                                    ...
                                    <p class="text-xs font-medium mb-0.5" style="color: var(--color-primary-2);">No hay semestres disponibles</p>
                                    <p class="text-xs" style="color: var(--color-secondary);">Crea semestres antes de asignarlos</p>
                                </div>
                            @endforelse
                        </div>
                    ...
                    <div class="p-3 rounded-lg border"
                        ...
                        <div class="flex items-center justify-between p-2 rounded-lg border"
                            ...
                            <div class="flex-1 min-w-0">
                                <p class="text-xs font-medium" style="color: var(--color-primary-2);">Periodo activo</p>
                                <p class="text-xs" style="color: var(--color-secondary);">Visible para los estudiantes</p>
                            </div>
                            ...
                            <div class="space-y-1.5">
                                @if($name)
                                    <div class="flex items-start gap-2">
                                        <span class="text-xs flex-shrink-0 mt-0.5" style="color: var(--color-secondary);">Nombre:</span>
                                        <span class="text-xs font-medium break-words" style="color: var(--color-primary-2);">{{ $name }}</span>
                                    </div>
                                @endif
                                @if($start_date)
                                    <div class="flex items-center gap-2">
                                        <span class="text-xs flex-shrink-0" style="color: var(--color-secondary);">Inicio:</span>
                                        <span class="text-xs font-medium" style="color: var(--color-primary-2);">
                                ...
                                @if($end_date)
                                    <div class="flex items-center gap-2">
                                        <span class="text-xs flex-shrink-0" style="color: var(--color-secondary);">Término:</span>
                                        <span class="text-xs font-medium" style="color: var(--color-primary-2);">
                                ...
                                @if(!empty($selectedSemesters))
                                    <div class="flex items-center gap-2">
                                        <span class="text-xs flex-shrink-0" style="color: var(--color-secondary);">Semestres:</span>
                                        <span class="text-xs font-medium" style="color: var(--color-primary-2);">
