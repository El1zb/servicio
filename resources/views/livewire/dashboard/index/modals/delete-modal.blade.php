...
<flux:modal
    ...
    <div class="flex flex-col">
        ...
        {{-- Footer --}}
        <div class="flex flex-col-reverse sm:flex-row items-center justify-end gap-2 pt-4 border-t border-[var(--color-border-hover)] shrink-0">

            <button wire:click="$set('isDeleteModalOpen', false)"
                    class="w-full sm:w-auto px-4 py-2 text-xs font-medium rounded-lg transition-all duration-200 hover:-translate-y-0.5 text-center
            ...
            <button wire:click="deletePeriod"
                    class="w-full sm:w-auto px-4 py-2 text-xs font-semibold rounded-lg transition-all duration-200
