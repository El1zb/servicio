                                ...
                                <div class="p-3 sm:p-4 rounded-lg sm:rounded-xl border-2 transition-all flex h-full peer-checked:border-2"
                                    ...
                                    <div class="flex items-center sm:items-stretch gap-3 w-full">
                                        ...
                                        <div class="flex-1 flex flex-col justify-between min-w-0">
                                            <div>
                                                <h4 class="font-semibold text-xs sm:text-sm mb-0.5 sm:mb-1 leading-tight" style="color: var(--period-detail-text-primary);">
                                                    {{ $modeData['label'] }}
                                                </h4>
                                                <p class="text-xs leading-tight" style="color: var(--period-detail-text-secondary);">
                                                    {{ $modeData['desc'] }}
                                                </p>
                                            </div>
                                        </div>
                            ...
                            <div class="flex items-start gap-3 sm:gap-4">
                                ...
                                <div class="flex-1 min-w-0">
                                    <div class="flex items-center gap-2 mb-1 sm:mb-2">
                                        ...
                                        <h4 class="text-sm sm:text-base font-medium" style="color: var(--period-detail-text-primary);">Documento Individual</h4>
                                    </div>
                                    <p class="text-xs sm:text-sm leading-relaxed" style="color: var(--period-detail-text-secondary);">
                    ...
                    @if(!($documentUploadMode === 'admin_only' && $isIndividual))
                        ...
                        <flux:field class="lg:col-span-2">
                            ...
                            <label for="documentFile"
                                ...
                                <div class="text-center">
                                    ...
                                    <p class="text-xs sm:text-sm font-medium transition-colors" style="color: var(--period-detail-text-secondary);">
                            ...
                            @if($documentFile)
                                <div class="mt-3 p-3 rounded-lg flex items-center gap-3"
                                    ...
                                    <span class="text-xs sm:text-sm flex-1 truncate" style="color: var(--period-detail-text-secondary);">{{ $documentFile->getClientOriginalName() }}</span>
                            ...
                            @elseif($editingDocumentId && $period->files->find($editingDocumentId)?->name_file && !$removeDocumentFile)
                                <div class="mt-3 p-3 rounded-lg flex items-center gap-3"
                                    ...
                                    <span class="text-xs sm:text-sm flex-1 truncate" style="color: var(--period-detail-text-secondary);">
                            ...
                            @elseif($editingDocumentId && $removeDocumentFile)
                                <div class="mt-3 p-3 rounded-lg flex items-center gap-3"
                                    ...
                                    <button wire:click="cancelRemoveDocumentFile" type="button"
                                        ...
                                        style="color: var(--period-detail-text-primary);">Cancelar</button>
                                </div>
                            @endif
                        ...
                        <div class="lg:col-span-2">
                            <label class="block text-sm font-semibold mb-3 flex items-center gap-2"
                                ...
                                Ejemplo (PDF)
                                <span class="text-xs font-normal hidden sm:inline" style="color: var(--period-detail-text-secondary);">
                            ...
                            <label for="documentExample"
                                ...
                                style="background-color: var(--period-detail-card-bg); border-color: var(--period-detail-border);"
                                onmouseover="this.style.borderColor='var(--period-detail-brand-secondary)';"
                                onmouseout="this.style.borderColor='var(--period-detail-border)';">
                                <div class="text-center">
                                    ...
                                    <p class="text-xs sm:text-sm font-medium" style="color: var(--period-detail-text-secondary);">Subir ejemplo</p>
                                </div>
                            </label>
                            ...
                            @if($documentExample)
                                <div class="mt-3 p-3 rounded-lg flex items-center gap-3"
                                    style="background-color: var(--period-detail-card-bg); border: 1px solid var(--period-detail-border);">
                                    <span class="text-xs sm:text-sm flex-1 truncate" style="color: var(--period-detail-text-secondary);">{{ $documentExample->getClientOriginalName() }}</span>
        ...
        <div class="backdrop-blur-xl rounded-xl sm:rounded-2xl shadow-xl sm:shadow-2xl overflow-hidden"
            ...
            <div class="p-4 sm:p-6"
                ...
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                    <div>
                        <h2 class="text-base sm:text-xl font-bold flex items-center gap-2" style="color: var(--period-detail-text-primary);">
                            <svg class="w-4 h-4 sm:w-5 sm:h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                                style="color: var(--period-detail-brand-primary);">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                        ...
                        <p class="text-xs sm:text-sm mt-0.5" style="color: var(--period-detail-text-secondary);">
            ...
            <div>
                    ...
                    <div class="p-4 sm:p-6 transition-all"
                        ...
                        <div class="flex items-start justify-between gap-3">
                            ...
                            <div class="flex items-start gap-3 flex-1 min-w-0">
                                ...
                                <div class="flex-1 min-w-0">
                                    <h3 class="text-sm sm:text-base font-semibold truncate" style="color: var(--period-detail-text-primary);">
                                        {{ $file->name }}
                                    </h3>
                ...
                @empty
                    <div class="p-10 sm:p-16 text-center">
                        ...
                        <p class="text-base sm:text-lg font-semibold mb-1 sm:mb-2" style="color: var(--period-detail-text-secondary);">No hay documentos base</p>
                        <p class="text-xs sm:text-sm" style="color: var(--period-detail-text-secondary);">Crea documentos para que los estudiantes puedan subirlos</p>
                    </div>
                @endforelse
            </div>
