    ...
    <div class="backdrop-blur-xl rounded-2xl p-2 flex flex-wrap gap-2"
        ...
        @foreach($tabs as $key => $data)
            <button
                ...
                onmouseover="if(this.style.backgroundColor !== 'var(--period-detail-btn-primary-bg)') {
                    this.style.backgroundColor = 'var(--period-detail-card-bg)';
                    this.style.color = 'var(--period-detail-text-primary)';
                }"
                onmouseout="if('{{ $activeTab }}' !== '{{ $key }}') {
                    this.style.backgroundColor = 'transparent';
                    this.style.color = 'var(--period-detail-text-secondary)';
                }"
            >
