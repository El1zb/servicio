<div class="space-y-8 min-h-screen p-6">
    ...
    <div class="w-full mb-8 rounded-xl shadow-sm p-6"
        ...
        >
            ...
            <span class="font-medium" style="color: var(--student-document-text-primary);">Volver a periodos</span>
        </button>
        ...
        <div class="flex items-start justify-between w-full">
            ...
            @if($period->is_active)
                <div class="bg-emerald-500/10 backdrop-blur-sm px-5 py-2.5 rounded-full border"
                    style="border-color: var(--status-border-approved); background-color: var(--status-icon-bg-approved);">
                    <div class="flex items-center gap-2">
                        <span class="relative flex h-2 w-2">
                            <span class="animate-ping absolute inline-flex h-full w-full rounded-full"
                                style="background-color: var(--status-icon-bg-approved); opacity: 0.75;"></span>
                            <span class="relative inline-flex rounded-full h-2 w-2"
                                style="background-color: var(--status-icon-color-approved);"></span>
                        </span>
                        <span class="font-semibold text-sm"
                            style="color: var(--status-icon-color-approved);">Activo</span>
                    </div>
                </div>
            @endif
        </div>
    ...
    <div class="w-full mb-6">
        <div class="grid gap-4 [grid-template-columns:repeat(auto-fit,minmax(220px,1fr))]">
            ...
            <!-- Total Estudiantes -->
            <div class="h-full rounded-xl p-5 shadow-lg transition-transform duration-200 hover:scale-[1.02] bg-[var(--student-document-bg)]">
                <div class="flex items-center justify-between h-full">
                    <div>
                        <p class="text-sm mb-1" style="color: var(--student-document-text-secondary);">Total Estudiantes</p>
                        <p class="text-3xl font-bold" style="color: var(--student-document-text-primary);">
            ...
            <div class="h-full rounded-xl p-5 shadow-lg transition-transform duration-200 hover:scale-[1.02] bg-[var(--student-document-bg)]">
                <div class="flex items-center justify-between h-full">
                    <div>
                        <p class="text-sm mb-1" style="color: var(--student-document-text-secondary);">Aprobados</p>
                        <p class="text-3xl font-bold" style="color: var(--student-document-text-primary);">
            ...
            <div class="h-full rounded-xl p-5 shadow-lg transition-transform duration-200 hover:scale-[1.02] bg-[var(--student-document-bg)]">
                <div class="flex items-center justify-between h-full">
                    <div>
                        <p class="text-sm mb-1" style="color: var(--student-document-text-secondary);">Pendientes</p>
                        <p class="text-3xl font-bold" style="color: var(--student-document-text-primary);">
            ...
            <div class="h-full rounded-xl p-5 shadow-lg transition-transform duration-200 hover:scale-[1.02] bg-[var(--student-document-bg)]">
                <div class="flex items-center justify-between h-full">
                    <div>
                        <p class="text-sm mb-1" style="color: var(--student-document-text-secondary);">Rechazados</p>
                        <p class="text-3xl font-bold" style="color: var(--student-document-text-primary);">
            ...
            <div class="h-full rounded-xl p-5 shadow-lg transition-transform duration-200 hover:scale-[1.02] bg-[var(--student-document-bg)]">
                <div class="flex items-center justify-between h-full">
                    <div>
                        <p class="text-sm mb-1" style="color: var(--student-document-text-secondary);">Documentos Base</p>
                        <p class="text-3xl font-bold" style="color: var(--student-document-text-primary);">
                            {{ $period->files->count() }}
                        </p>
                    </div>
        ...
        <div class="backdrop-blur-xl rounded-2xl p-2 inline-flex gap-2" 
            ...
            @foreach($tabs as $key => $data)
                <button
                    ...
                    {{ $activeTab === $key ? '' : '' }}"
                    style="{{ $activeTab === $key 
                        ? 'background-color: var(--modal-btn-document-descargar); color: var(--modal-btn-document-descargar-text); box-shadow: 0 10px 15px -3px rgba(0, 0, 0, 0.3);' 
                        : 'color: var(--student-document-text-secondary);' }}"
                    onmouseover="if(this.style.backgroundColor !== 'var(--modal-btn-document-descargar)') { this.style.backgroundColor = 'var(--student-document-bg-card)'; this.style.color = 'var(--student-document-text-primary)'; }"
                    onmouseout="if('{{ $activeTab }}' !== '{{ $key }}') { this.style.backgroundColor = 'transparent'; this.style.color = 'var(--student-document-text-secondary)'; }"
                >
    ...
    <div class="w-full">
        ...
        @if($activeTab === 'estudiantes')
            <div class="backdrop-blur-xl rounded-2xl shadow-2xl overflow-hidden" 
                ...
                {{-- Header --}}
                <div class="p-6" style="border-bottom: 1px solid var(--student-document-border-content);">
                    <h2 class="text-2xl font-bold mb-2" style="color: var(--student-document-text-primary);">Gestión de Estudiantes</h2>
                    <p style="color: var(--student-document-text-secondary);">Revisa el perfil de los estudiantes</p>
                ...
                <div class="overflow-x-auto rounded-2xl ">
                    <table class="w-full">
                        <thead style="background: linear-gradient(135deg, var(--student-document-bg-card-header-approved) 0%, var(--student-document-bg-card-header-approved-2) 100%);">
                            <tr>
                                <th class="px-6 py-4 text-left text-xs font-semibold uppercase" 
                                    style="color: var(--student-document-text-secondary);">Nombre</th>
                                <th class="px-6 py-4 text-left text-xs font-semibold uppercase" 
                                    style="color: var(--student-document-text-secondary);">Avance Reticular</th>
                                <th class="px-6 py-4 text-left text-xs font-semibold uppercase" 
                                    style="color: var(--student-document-text-secondary);">Estatus</th>
                                <th class="px-6 py-4 text-left text-xs font-semibold uppercase" 
                                    style="color: var(--student-document-text-secondary);">Acciones</th>
                            </tr>
                        </thead>

                        <tbody style="border-top: 1px solid var(--student-document-border-content);">
                            @forelse($students as $student)
                            <tr class="transition hover-row" 
                                onmouseover="this.style.backgroundColor='var(--student-document-bg-card)'"
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-3">
                                        <div class="w-10 h-10 rounded-lg flex items-center justify-center font-semibold text-white"
                                            ...
                                            {{ strtoupper(substr($student->name, 0, 1) . substr($student->last_name_paterno, 0, 1)) }}
                                        </div>
                                        <div>
                                            <p class="font-medium" style="color: var(--student-document-text-primary);">
                                ...
                                <td class="px-6 py-4">
                                    <button
                                        ...
                                        style="background-color: var(--modal-btn-document-cerrar); 
                                               color: var(--modal-btn-document-cerrar-text);"
                                        onmouseover="this.style.backgroundColor='var(--modal-btn-document-descargar)'; this.style.transform='translateY(-2px)'; this.style.color='var(--modal-btn-document-descargar-text)';"
                                        onmouseout="this.style.backgroundColor='var(--modal-btn-document-cerrar)'; this.style.transform='translateY(0)'; this.style.color='var(--modal-btn-document-cerrar-text)';"
                                    >
                            ...
                            @empty
                            <tr>
                                <td colspan="4" class="px-6 py-12 text-center" style="color: var(--student-document-text-secondary);">
                    ...
                    <div class="backdrop-blur-xl rounded-2xl shadow-2xl overflow-hidden" 
                        ...
                        <div class="p-6" 
                            ...
                            <div class="flex items-center justify-between gap-4">
                                {{-- Título --}}
                                <div>
                                    <h2 class="text-xl font-bold flex items-center gap-2" style="color: var(--student-document-text-primary);">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                                            style="color: var(--color-hero-accent-primary);">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
                                                d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                                    ...
                                    <p class="text-sm mt-1" style="color: var(--student-document-text-secondary);">
                        ...
                        <div>
                                    ...
                                    <div class="flex items-start justify-between gap-4">
                                        <div class="flex-1 min-w-0">
                                            <div class="flex items-start gap-3">
                                                ...
                                                <div class="flex-1 min-w-0">
                                                    <h3 class="text-lg font-semibold truncate" style="color: var(--student-document-text-primary);">{{ $file->name }}</h3>
                                                    <div class="flex flex-wrap items-center gap-3 mt-2 text-sm" style="color: var(--student-document-text-secondary);">
                                                        <!-- Fecha de subida -->
                                        ...
                                        <div class="flex gap-1 items-center">
                                            ...
                                            @if($file->file_path)
                                                <button wire:click="previewFile('{{ $file->file_path }}','{{ $file->name_file }}')"
                                                        class="w-8 h-8 flex items-center justify-center rounded-lg 
                                                            bg-[var(--student-document-bg-button-word)] 
                                                            text-[var(--student-document-text-button)] 
                                                            hover:bg-[var(--student-document-bg-button-word-hover)] 
                                            ...
                                            @if($file->example_path)
                                                <button wire:click="previewFile('{{ $file->example_path }}','{{ $file->example_name_file }}')"
                                                        class="w-8 h-8 flex items-center justify-center rounded-lg 
                                                            bg-[var(--student-document-bg-button-pdf)] 
                                                            text-[var(--student-document-text-button)] 
                                                            hover:bg-[var(--student-document-bg-button-pdf-hover)] 
                                                            hover:-translate-y-1 hover:shadow-md
                                                            transition-all duration-200 cursor-pointer text-xs">
                                            ...
                                            <button wire:click="editDocument({{ $file->id }})"
                                                    class="w-8 h-8 flex items-center justify-center rounded-lg 
                                                        bg-[var(--student-document-bg-button-view)] 
                                                        text-[var(--student-document-text-button-view)] 
                                                        hover:bg-[var(--student-document-bg-button-view-hover)] 
                                                        hover:-translate-y-1 hover:shadow-md
                                                        transition-all duration-200 cursor-pointer text-xs">
                                            ...
                                            <button wire:click="deleteDocument({{ $file->id }})"
                                                    class="w-8 h-8 flex items-center justify-center rounded-lg 
                                                        ...
                                                        text-[var(--student-document-text-button)] 
                                                        hover:bg-[var(--student-document-bg-button-view-replace)] 
                                                        hover:-translate-y-1 hover:shadow-md
                                                        transition-all duration-200 cursor-pointer text-xs">
                            ...
                            @empty
                                <div class="p-16 text-center">
                                    ...
                                    <p class="text-lg font-semibold mb-2" style="color: var(--student-document-text-secondary);">No hay documentos base</p>
                                    <p class="text-sm" style="color: var(--student-document-text-secondary);">Crea documentos para que los estudiantes puedan subirlos</p>
                                </div>
                            @endforelse
                        </div>
        ...
        @if($activeTab === 'revision')
            <div class="backdrop-blur-xl rounded-2xl shadow-2xl overflow-hidden" 
                ...
                {{-- Header --}}
                <div class="p-6" style="border-bottom: 1px solid var(--student-document-border-content);">
                    <h2 class="text-2xl font-bold mb-2" style="color: var(--student-document-text-primary);">
                        Revisión de Documentos
                    </h2>
                    <p style="color: var(--student-document-text-secondary);">
                    ...
                    <div class="mt-4 flex flex-col lg:flex-row gap-3 items-center">
                        ...
                        <button 
                            ...
                            wire:loading.attr="disabled"
                            class="px-5 py-2.5 text-white font-semibold rounded-lg shadow-sm transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2 whitespace-nowrap"
                            style="background: linear-gradient(135deg, var(--color-hero-accent-primary) 0%, var(--color-hero-accent-secondary) 100%);"
                            onmouseover="this.style.transform='translateY(-2px)'; this.style.boxShadow='0 20px 25px -5px rgba(0, 0, 0, 0.3)';"
                            onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 10px 15px -3px rgba(0, 0, 0, 0.3)';"
                        >
                            ...
                            <thead style="background: linear-gradient(135deg, var(--student-document-bg-card-header-approved) 0%, var(--student-document-bg-card-header-approved-2) 100%);">
                                <tr>
                                    <th class="px-6 py-4 text-left text-xs font-semibold uppercase w-12" 
                                        style="color: var(--student-document-text-secondary);"></th>
                                    <th class="px-6 py-4 text-left text-xs font-semibold uppercase" 
                                        style="color: var(--student-document-text-secondary);">Estudiante</th>
                                    <th class="px-6 py-4 text-left text-xs font-semibold uppercase" 
                                        style="color: var(--student-document-text-secondary);">Carrera</th>
                                    ...
                                    <th class="px-6 py-4 text-center text-xs font-semibold uppercase" 
                                        style="color: var(--student-document-text-secondary);">Seguimiento</th>
                                </tr>
                            </thead>
                            ...
                            <tbody style="border-top: 1px solid var(--student-document-border-content);">
                                @forelse($studentsRevision as $student)
                                    ...
                                    <tr 
                                        ...
                                        onmouseover="this.style.backgroundColor='var(--student-document-bg-card)'" 
                                        onmouseout="this.style.backgroundColor='transparent'"
                                        style="border-bottom: 1px solid var(--student-document-border-content);"
                                    >
                                        {{-- Botón expandir (solo visual, ya no necesita click) --}}
                                        <td class="px-6 py-4">
                                            <div class="p-1.5 rounded-lg transition" style="background-color: var(--student-document-bg-card);">
                                        ...
                                        <td class="px-6 py-4">
                                            <div class="flex items-center gap-3">
                                                <div class="w-10 h-10 rounded-lg flex items-center justify-center font-semibold text-white text-sm flex-shrink-0"
                                                    style="background: linear-gradient(135deg, var(--color-hero-accent-primary) 0%, var(--color-hero-accent-secondary) 100%);">
                                        ...
                                        {{-- Carrera --}}
                                        <td class="px-6 py-4">
                                            <span class="text-sm" style="color: var(--student-document-text-primary);">{{ Str::limit($student->career->name ?? 'N/A', 30) }}</span>
                                        </td>
                                        ...
                                        <td class="px-6 py-4 text-center">
                                            <span class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-sm font-semibold" 
                                                style="background-color: rgba(232, 210, 50, 0.2); color: var(--student-document-calendar-pending);">
                                        ...
                                        <td class="px-6 py-4 text-center">
                                            <span class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-sm font-semibold" 
                                                style="background-color: rgba(239, 68, 68, 0.2); color: var(--student-document-text-content-status-rejected-icon);">
                                        ...
                                        <td class="px-6 py-4">
                                            <div class="flex items-center justify-center gap-2" onclick="event.stopPropagation()">
                                                <button
                                                    ...
                                                    style="background-color: var(--modal-btn-document-cerrar); 
                                                        color: var(--modal-btn-document-cerrar-text);"
                                                    onmouseover="this.style.transform='translateY(-2px)'; this.style.boxShadow='0 5px 10px rgba(0,0,0,0.2)'; this.style.backgroundColor='var(--modal-btn-document-descargar)'; this.style.color='var(--modal-btn-document-descargar-text)';"
                                                    onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='none'; this.style.backgroundColor='var(--modal-btn-document-cerrar)'; this.style.color='var(--modal-btn-document-cerrar-text)';"
                                                    title="Exportar PDF"
                                                >
                                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    ...
                                    @if($expandedStudent === $student->id)
                                        <tr style="background-color: var(--student-document-bg-card);">
                                        ...
                                        <td colspan="8" class="px-6 py-16 text-center">
                                            <div class="flex flex-col items-center">
                                                <svg class="w-16 h-16 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                                                    style="color: var(--student-document-text-secondary); opacity: 0.4;">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 13V6a2 2 0 00-2-2H6a2 2 0 00-2 2v7m16 0v5a2 2 0 01-2 2H6a2 2 0 01-2-2v-5m16 0h-2.586a1 1 0 00-.707.293l-2.414 2.414a1 1 0 01-.707.293h-3.172a1 1 0 01-.707-.293l-2.414-2.414A1 1 0 006.586 13H4"/>
                                        </svg>
                                        <p class="font-semibold mb-1" style="color: var(--student-document-text-secondary);">No se encontraron estudiantes</p>
                                        <p class="text-sm" style="color: var(--student-document-text-secondary); opacity: 0.7;">Intenta con otros filtros de búsqueda</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
                ...
                <div 
                    ...
                    <div class="relative flex items-center gap-4 flex-1 min-w-0">
                        ...
                        <div 
                            ...
                            style="
                                background: linear-gradient(135deg, var(--color-hero-accent-primary), var(--color-hero-accent-secondary));
                            ">
                        ...
                        {{-- Info del estudiante --}}
                        <div class="flex-1 min-w-0">
                            <h2 class="text-xl font-bold truncate" style="color: var(--student-document-text-primary);">
                                {{ $selectedStudent->name }}
                                {{ $selectedStudent->last_name_paterno }}
                                {{ $selectedStudent->last_name_materno }}
                            </h2>
                            <div class="flex items-center gap-3 mt-1">
                                <span class="text-sm font-medium" style="color: var(--student-document-text-secondary);">
                            ...
                            <div 
                                ...
                                <div class="px-5 py-4">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <h3 class="text-base font-semibold" style="color: var(--student-document-text-primary);">
                                    ...
                                    @else
                                        ...
                                        <div class="space-y-3">
                                            <div class="flex items-start justify-between p-3 rounded-lg transition-colors"
                                                style="background-color: var(--student-document-bg-card);">
                                                <div class="flex-1">
                                                    <p class="text-xs font-medium mb-0.5" style="color: var(--student-document-text-secondary);">
                                                        CURP
                                                    </p>
                                                ...
                                                <svg class="w-4 h-4 mt-1" style="color: var(--student-document-text-secondary);" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                                                </svg>
                                            </div>
                                            ...
                                            <div class="flex items-start justify-between p-3 rounded-lg transition-colors"
                                                ...
                                                <div class="flex-1">
                                                    ...
                                                    <p class="text-sm font-semibold truncate" style="color: var(--student-document-text-primary);">
                                                        {{ $selectedStudent->personal_email ?: '—' }}
                                                    </p>
                                                </div>
                                                <svg class="w-4 h-4 mt-1 flex-shrink-0" style="color: var(--student-document-text-secondary);" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="flex gap-2 w-full sm:w-auto">
                        ...
                        @else
                            ...
                            <button
                                ...
                                style="
                                    background-color: var(--modal-btn-approve);
                                    color: var(--modal-btn-approve-text);
                                "
                                onmouseover="this.style.transform='translateY(-2px)'; this.style.filter='brightness(1.1)';"
                                onmouseout="this.style.transform='translateY(0)'; this.style.filter='brightness(1)';">
                                <span class="flex items-center gap-2">
                    ...
                    <div class="space-y-4">
                        ...
                        <div 
                            ...
                            <div class="flex gap-3">
                                <svg class="w-5 h-5 flex-shrink-0 mt-0.5" style="color: var(--student-document-text-content-status-rejected-icon);" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                                </svg>
                                <div class="flex-1">
                                    <p class="text-sm font-semibold mb-1" style="color: var(--student-document-text-content-status-rejected-icon);">
                                        Atención
                                    </p>
                                    <p class="text-xs" style="color: var(--student-document-text-secondary);">
                        ...
                        <div>
                            <label class="block text-sm font-semibold mb-2" style="color: var(--student-document-text-primary);">
                                Motivo del rechazo <span style="color: var(--student-document-text-content-status-rejected-icon);">*</span>
                            </label>
                            <textarea
                            ...
                            @enderror
                            <p class="mt-1.5 text-xs" style="color: var(--student-document-text-secondary);">
            ...
            <div class="flex flex-col h-[90vh] max-h-[95vh]">
                ...
                <div 
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        @endif
                        <div>
                            <h3 class="font-semibold" style="color: var(--student-document-text-primary);">
                                {{ $previewName }}
                            </h3>
                            <p class="text-sm" style="color: var(--student-document-text-secondary);">
                ...
                {{-- Área de Contenido --}}
                <div class="flex-1 overflow-hidden {{ $ext !== 'pdf' ? 'rounded-b-xl' : '' }}" style="background-color: var(--student-document-bg-card); ">
                    @if($ext === 'pdf')
                        ...
                        <div class="w-full h-full flex flex-col items-center justify-center p-8">
                            <div class="max-w-md text-center space-y-6">
                                ...
                                <div class="inline-flex items-center justify-center w-24 h-24 rounded-2xl"
                                    style="background-color: var(--student-document-bg-content);">
                                    <svg class="w-12 h-12" style="color: var(--student-document-text-secondary);" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                {{-- Mensaje --}}
                                <div class="space-y-2">
                                    <h4 class="text-lg font-semibold" style="color: var(--student-document-text-primary);">
                            ...
                            <span
                                ...
                                style="
                                    ...
                                    @elseif($quickReviewDoc->status === 'rechazado')
                                        ...
                                        color: var(--student-document-text-content-status-rejected-icon);
                                        border-color: rgba(239, 68, 68, 0.3);
                                    @else
                                        background-color: rgba(232, 210, 50, 0.15);
                                        color: var(--student-document-calendar-pending);
                            ...
                            @if($quickReviewPreviewUrl)
                                ...
                                @else
                                    ...
                                    ">
                                        ...
                                        <p class="text-sm text-[var(--student-document-text-secondary)] mb-1">
                                            Vista previa no disponible
                                        </p>
