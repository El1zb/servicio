            ...
            <div class="relative hidden h-full flex-col p-10 lg:flex" style="background-color: var(--color-primary-2); color: var(--color-bg);">
                ...
                <div class="relative z-20 mt-auto">
                    <blockquote class="space-y-2">
                        <flux:heading size="lg" style="color: var(--color-bg);">&ldquo;{{ trim($message) }}&rdquo;</flux:heading>
                        <footer><flux:heading style="color: var(--color-bg);">{{ trim($author) }}</flux:heading></footer>
                    </blockquote>
                </div>
            </div>
